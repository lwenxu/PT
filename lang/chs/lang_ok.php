...
(
	...
	'std_cookies_disabled_note' => "<p>你的账号已成功激活！但是，你没有自动登录。你可能需要打开浏览器的新窗口才能登录。<br />产生此问题的原因可能是因为你禁用了浏览器的cookies。你可以直接点击登录链接进行登录<a class=altlink href=\"login.php\">登录</a>。</p>\n",
